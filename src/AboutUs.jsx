...
import backgroundImage from "/aboutUs-background.svg";
import rightImage from "/aboutUS-logo.svg";
// import rightImage from "/asset.svg";
...
const AboutUs = () => {
  return (
    ...
    >
      ...
      <section className="col-span-5 md:col-span-5 sm:col-span-12 z-10 flex flex-col justify-center px-4 py-8 md:px-12 lg:px-16">
      ...
      {/* Right Image Section */}
      <div
        className="col-span-7 hidden sm:hidden md:block absolute md:relative right-0 top-0 h-full"
        style={{
